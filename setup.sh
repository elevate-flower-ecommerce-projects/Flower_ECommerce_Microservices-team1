...
echo -e "  🏥 Identity Health Check: \033[1;33m${BASE_URL}/identity\033[0m"
echo -e "  🏥 Catalog Health Check:  \033[1;33m${BASE_URL}/catalog\033[0m"
echo -e "  🏥 Cart Health Check:     \033[1;33m${BASE_URL}/cart\033[0m"
echo -e "  🏥 Order Health Check:    \033[1;33m${BASE_URL}/orders\033[0m"
echo -e "  🏥 Payment Health Check:  \033[1;33m${BASE_URL}/payments\033[0m"
echo -e "  🏥 Address Health Check:  \033[1;33m${BASE_URL}/address\033[0m"
echo -e "\033[1;36m=================================================================\033[0m"
