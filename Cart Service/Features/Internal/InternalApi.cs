...
namespace Cart_Service.Features.Internal;

public static class InternalRoutes
{
    // The gateway strips the "/cart" prefix, so this lives under /internal on this service.
    public const string ClearUserCart = "/internal/carts/{userId}/clear";
}
...
public static class InternalMessages
{
    ...
    public const string UserIdRequired = "A user id is required.";
}
