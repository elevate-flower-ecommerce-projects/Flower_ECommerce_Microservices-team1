...
public class AdminLoginEndpoint : ICarterModule
{
    ...
    {
        app.MapPost("admin/login", async (HttpContext httpContext, [FromBody] LoginRequest request, ISender sender, CancellationToken cancellationToken) =>
        {
        ...
        app.MapPost("admin/refresh", async ([FromBody] RefreshTokenRequest request, ISender sender, CancellationToken cancellationToken) =>
        {
        ...
        app.MapGet("admin/session", () => Results.NoContent())
